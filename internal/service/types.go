...
// Single source of truth for both service layer and API.
// Tags serve dual purpose: Huma reads them for OpenAPI + validation.
type LayerConfig struct {
	...
	File           string       `json:"file" required:"true" doc:"Source file name" example:"buildings.pmtiles"`
	PMTilesLayer   string       `json:"pmtilesLayer,omitempty" doc:"Layer name within PMTiles" example:"buildings"`
	GeomType       string       `json:"geomType" required:"true" enum:"polygon,line,point" doc:"Geometry type" example:"polygon"`
	DefaultVisible bool         `json:"defaultVisible" default:"true" doc:"Whether layer is visible by default" example:"true"`
	Fill           string       `json:"fill,omitempty" doc:"Fill color (CSS)" example:"#3388ff"`
	Stroke         string       `json:"stroke,omitempty" doc:"Stroke color (CSS)" example:"#2266cc"`
